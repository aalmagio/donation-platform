...
if ( isset( $_GET[ 'date3' ] ) && isset( $_GET[ 'date4' ] ) ) {
    if ( $_GET[ 'date3' ] > date( "Y-m-d" ) ) {
        ...
        if ( isset( $_GET[ 'ID_Mentor' ] ) && $_GET[ 'ID_Mentor' ] == "NOTNULL" ) {
            ...
            $query_donazione = sprintf( "SELECT Anagrafica.Id_a,Anagrafica.ID_Mentor, Anagrafica.nome, Anagrafica.cognome, Anagrafica.ragioneSociale, Anagrafica.data_ins,
                Mandato.CodiceMandatoMentor,  Mandato.frequenza, Mandato.importo
                FROM Mandato 
                LEFT JOIN Anagrafica ON Mandato.Id_a = Anagrafica.Id_A 
                WHERE 
                Mandato.`metodo` <> 'K' 
            ...
            //Query conteggio
            $query_count_donazione = sprintf( "SELECT count(Anagrafica.Id_a) AS N_righe
                FROM Mandato 
                LEFT JOIN Anagrafica ON Mandato.Id_a = Anagrafica.Id_A 
                WHERE 
                Mandato.`metodo` <> 'K' 
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Verifica Mandati SDD</h1>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    <thead>
                        <tr>
                            <?php if (($row_donazione['ID_Mentor']!="" && $row_donazione['CodiceMandatoMentor'] !="")  &&  $_SESSION['MM_UserGroup'] =="A"){ ?>
                            <th>Reset</th>
                            <?php } ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo stripslashes($row_donazione['frequenza']); ?></td>
                            <td style="text-align: right;">&euro; <?php echo $row_donazione['importo']; ?>.00</td>
                            <td><?php echo stripslashes($row_donazione['data_ins']); ?></td>
                            ...
                            <td><?php if ($row_donazione['ID_Mentor']=="" &&  ($_SESSION['MM_UserGroup'] =="A" ||$_SESSION['MM_UserGroup'] =="S")){ ?>
                                <a href="singolosdd.php?Id_a=<?php echo stripslashes($row_donazione['Id_a']); ?>"><strong>Scrivi in Mentor</strong></a>
                                <?php
                                ...
                                ?></td>
                            <td><?php if ($row_donazione['CodiceMandatoMentor']=="" &&  ($_SESSION['MM_UserGroup'] =="A" ||$_SESSION['MM_UserGroup'] =="S")){ ?>
                                <a href="singolosdd.php?Id_a=<?php echo stripslashes($row_donazione['Id_a']); ?>"><strong>Scrivi in Mentor</strong></a>
                                <?php
                                } elseif ( $row_donazione[ 'CodiceMandatoMentor' ] == "" && $_SESSION[ 'MM_UserGroup' ] == "U" ) {
                                    echo "<span style=\"color:#F00; font-weight: bold;\">mandato non importato </span>";
                                }
                                else {
                        ...
                        <tr>
                            <?php if ($row_donazione['ID_Mentor']!="" &&  $_SESSION['MM_UserGroup'] =="A"){ ?>
