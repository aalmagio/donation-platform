...
('DEFAULT', 'GOAL', '10000'),
('DEFAULT', 'IMPORTO_MINIMO_ONE', '5'),
('DEFAULT', 'IMPORTO_MINIMO_MENSILE', '5'),
('DEFAULT', 'IMPORTO_MINIMO_ANNUALE', '100'),
('DEFAULT', 'IMPORTO_MINIMO_REG', '5'),
-- Importi suggeriti per tipo donazione (CSV, dal più basso al più alto)
('DEFAULT', 'AMOUNTS_ONEOFF', '20,30,50,100'),
('DEFAULT', 'AMOUNTS_MENSILE', '10,15,25,50'),
('DEFAULT', 'AMOUNTS_ANNUALE', '120,180,300,600'),
